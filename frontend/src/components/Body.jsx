    ...
    <div className="bg-[#181e24]  overflow-x-hidden font-custom">
      ...
      <div className="h-24"></div>
        ...
        <div className="bg-[#181e24] w-full">
          ...
          <div className="px-40 py-4 mb-16  grid grid-rows-2   justify-center md:grid-cols-3 ">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 md:gap-6 gap-y-8 py-8 md:py-16 items-center justify-center px-10 ">
